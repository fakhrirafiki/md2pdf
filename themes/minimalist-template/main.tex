...
% Page layout
\usepackage{geometry}
\geometry{paperwidth=90mm, paperheight=200mm, top=2cm, bottom=2cm, left=0.5cm, right=0.5cm} % smartphone
% \geometry{paperwidth=145mm, paperheight=210mm, top=2cm, bottom=2cm, left=2.5cm, right=2.2cm} % A5
